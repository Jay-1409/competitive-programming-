    ...
    f0r(i,n){
        f0r(j,n){
            if(arr[i][j]=='.' || '#'){
                if(i==0){
                    if(j==0){
                        if(arr[i+1][j]=='#' && arr[i][j+1]=='#' && arr[i+1][j+1]=='#' && i+1<n && j+1<n){
                            ok=true; break;
                        }
                    } else {
                        if(arr[i+1][j]=='#' && arr[i][j+1]=='#' && arr[i+1][j+1]=='#' && i+1<n && j+1<n){
                            ok=true; break;
                        } else if(arr[i+1][j]=='#' && arr[i][j-1]=='#' && arr[i+1][j-1]=='#' && i+1<n && j+1<n){
                            ok=true; break;
                        }
                    }
                } else {
                    if(j==0){
                        if(arr[i+1][j]=='#' && arr[i][j+1]=='#' && arr[i+1][j+1]=='#' && i+1<n && j+1<n){
                            ok=true; break;
                        } else if(i>0 && j+1<n && arr[i-1][j]=='#' && arr[i][j+1]=='#' && arr[i-1][j+1]=='#' && i+1<n && j+1<n){
                            ok=true; break;
                        }
                    } else {
                        if(arr[i+1][j]=='#' && arr[i][j+1]=='#' && arr[i+1][j+1]=='#' && i+1<n && j+1<n){
