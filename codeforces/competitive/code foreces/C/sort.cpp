...
// int level(int l,int r,string a,string b){
//     int cnt=0;
//     string x=a.substr(l-1,r-l+1);
//     string y=b.substr(l-1,r-l+1);
//     int p=0;
//     int n=len(x);
//     map<char,int> mp2;
//     f0r(i,n){
...
void solve() {
    ...
    f0r(i,q){
        ...
        // p.pb({t1,t2});
            ...
            string x=a;
            string y=b;
            // string x=a.substr(t1-1,t2-t1+1);
            // string y=b.substr(t1-1,t2-t1+1);
            int p=t1-1;
            map<char,int> mp2;
            f0r(i,t1-1,t2){
                mp2[y[i]]++;
