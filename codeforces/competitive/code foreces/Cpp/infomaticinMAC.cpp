...
//     int N = arr.size();
//     vector<bool> present(N + 1, false); // boolean array to mark presence of numbers
...
//     return N + 1; // In case all numbers from 0 to N are present
// }
int mex(const vector<int> &arr, int N) {
...
//         } 
//         if(!curok){
//             currmex=mex(tack,len(tack));
//             curok=true;
//         }else{
//             int newmex=mex(tack,len(tack));
//             if(newmex!=currmex){
//                 cout<<-1<<endl; return;
//             }
//         }
