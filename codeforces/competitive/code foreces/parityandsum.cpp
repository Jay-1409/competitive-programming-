...
void solve() {
    ...
    s0rt(od);
    if(ok){
        long long maxod = od.back;
        // f0r(i,n){
        //     if(v[i] > maxod && v[i] % 2 != 0){
        //         maxod = v[i];
        //     }
        // }
        int cnt=0;
        ...
        f0r(i,len(ev)){
            if(ev[i] < maxod){
                ...
                cout<<abs(len(ev))+1<<endl;return;
            }
        }
        // cout<<11<<endl;
        cout<<cnt<<endl;
        // // long long maxod=-1e10;
        // f0r(i,n){
        //     if(v[i] % 2 != 0 && v[i] > maxod){
        //         maxod = v[i];
        //     }
        // }
        // cout<<maxod<<" "<<maxev<<endl;
        // if(maxod>maxev){
        //     cnt+=0;
        // }else{
        //     f0r(i,n){
        //         if(v[i] > maxod && v[i] % 2 ==0 ){cnt++;}
        //     }
        // }
    } else{
        cout<< 0 << endl;
