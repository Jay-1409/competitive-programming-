...
void solve() {
    ...
    f0r(i,m)cin>>d[i];
    unordered_map<long long int,long long int> v;
...
void solve2(){
    ...
    vector<long long int> b(n);
    f0r(i,n)cin>>b[i];
    set<long long int> bs;
    f0r(i,n){
        bs.insert(b[i]);
    }
    multiset<long long int> re;
    f0r(i,n){
        if(a[i]!=b[i]){
            re.insert(b[i]);
        }
